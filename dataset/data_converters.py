...
def conll09_predicate_binary_converter(split_line, idx):
    return [str(split_line[idx] != '_')]

def conll09_predicate_sense_converter(split_line, idx):
    verb_sense_str = split_line[idx]
    just_verb_sense = verb_sense_str if verb_sense_str == "_" else split_line[idx - 1]
...
dispatcher = {
    ...
    'conll09_predicate_binary': conll09_predicate_binary_converter
}
